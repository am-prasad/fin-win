...
export function ChatInterface({ className = "", onSendMessage }) {
  const [messages, setMessages] = useState([
    {
      id: "1",
      type: "ai",
      content:
        "Hello! I'm your AI Financial Assistant. I can help you analyze your finances, plan investments, and answer any financial questions. What would you like to know?",
      timestamp: new Date(),
      insights: [
        {
          type: "positive",
  ...
  const generateAIResponse = (userMessage) => {
    const responses = [
      {
        content:
          "Based on your current portfolio, you're well-diversified with 38% in equity funds and 23% in debt funds. Your SIP performance shows consistent 11% returns.",
        insights: [
          {
            type: "positive",
      ...
      {
        content:
          "Your emergency fund currently covers 4.2 months of expenses. Financial experts recommend 6-12 months. Consider increasing your liquid savings by ₹50,000.",
        insights: [
          {
            type: "warning",
      ...
      {
        content:
          "Great question! Your retirement planning is on track. With your current SIP of ₹15,000/month, you're projected to accumulate ₹2.8 crores by age 60.",
        insights: [
          {
            type: "positive",
  ...
  const addVoiceMessage = (userText, aiResponse) => {
    const userMessage = {
  ...
  useEffect(() => {
    window.addVoiceMessage = addVoiceMessage;
    return () => {
      delete window.addVoiceMessage;
    };
  }, []);
