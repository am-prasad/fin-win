...
// ===== Placeholder SidebarMenu components =====
...
const SidebarMenuItem = React.forwardRef(({ className, ...props }, ref) => (
  <li ref={ref} data-sidebar="menu-item" className={cn("px-2 py-1 cursor-pointer", className)} {...props} />
));
SidebarMenuItem.displayName = "SidebarMenuItem";

const SidebarMenuButton = SidebarMenuItem;
const SidebarMenuAction = SidebarMenuItem;
const SidebarMenuBadge = SidebarMenuItem;
const SidebarMenuSkeleton = Skeleton;
const SidebarMenuSub = SidebarMenu;
const SidebarMenuSubButton = SidebarMenuItem;
