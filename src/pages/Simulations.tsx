...
const Simulations = () => {
  ...
  const calculateSIP = () => {
    ...
    const futureValue = sipAmount * (((Math.pow(1 + monthlyReturn, totalMonths) - 1) / monthlyReturn) * (1 + monthlyReturn));
              ...
              <CardContent>
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  >
                    ...
                    <div className="text-sm text-muted-foreground">₹10K/month for 25 years</div>
                  </Button>
                  ...
                  >
                    ...
                    <div className="text-sm text-muted-foreground">₹25K/month for 20 years</div>
                  </Button>
                  ...
                  >
                    ...
                    <div className="text-sm text-muted-foreground">₹50K/month for 15 years</div>
                  </Button>
                </div>
              </CardContent>
            </Card>
